...
class Status
{
    ...
    public function save(): void
    {
        ...
        $record = [
            ...
            'uri' => $this->config->getProto(). '://' . $this->config->getInstance() . '/users/' . $this->config->getUsername() . '/statuses/' . $this->id,
            'url' => $this->config->getProto(). '://' . $this->config->getInstance() . '@' . $this->config->getUsername() . '/statuses/' . $this->id,
